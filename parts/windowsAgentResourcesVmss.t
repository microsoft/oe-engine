...
{{end}}
      ...
      "tags":
      {
        "creationSource" : "[concat('oe-engine-', variables('{{.Name}}VMNamePrefix'), '-vmss')]"
      },
      "location": "[variables('location')]",
...
{{end}}
          ...
          "osProfile": {
            "computerNamePrefix": "[concat('oe-', substring(variables('nameSuffix'), 0, 4))]",
            "adminUsername": "[variables('windowsAdminUsername')]",
            "adminPassword": "[variables('windowsAdminPassword')]",
            {{GetWindowsAgentCustomData .}}
